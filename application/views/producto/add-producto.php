...
?>
  <div class="form-row"> 
    <div class="col-sm-1">
      ...
      <input type="text" class="form-control" id="prod_code" name="prod_code" value="<?php echo set_value('prod_code'); ?>">
    </div>
  </div>
  <div class="form-row">
    <div class="col-sm-6">
      <label for="prod_descrip">Descripción:</label>
      <input type="text" class="form-control" id="prod_descrip" name="prod_descrip" value="<?php echo set_value('prod_descrip'); ?>">
    </div>
  </div>
  <div class="form-row">  
    <div class="col-sm-2">
      <label for="prod_precio">Precio:</label>
      <input type="number" class="form-control" id="prod_precio" name="prod_precio" value="<?php echo set_value('prod_precio'); ?>">
    </div>
    <div class="col-sm-2">
      <label for="prod_stock">Stock:</label>
      <input type="number" class="form-control" id="prod_stock" name="prod_stock" value="<?php echo set_value('prod_stock'); ?>">
    </div>
    <div class="col-sm-2">
      <p>Ctrl. de sotck:</p>
  ...
  <div class="form-row"> 
     <div class="col-sm-4">
      ...
      <?php
        ...
        echo form_dropdown('cat_code', $categorias, set_value('cat_code'),$attrib);
       ?>
    </div>
  </div>  
  <br> 
